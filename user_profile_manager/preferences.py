...
class EnhancedPreferenceExtractor:
    ...
    def extract_preferences(self, text, user_id="user"):
        ...
        for match_id, start, end in matches:
            ...
            if pattern_name == "FAVORITE_COLOR_PATTERN":
                results.append({
                    ...
                    "context": f"likes the color {doc[start].text.lower()}"
                })
                ...
                activity = doc[start+3].text.lower()
                results.append({
                    "original_input": text,
                    "user_id": user_id,
                ...
                activity = doc[start+4].text.lower()  # Note: index is now +4 because of the split tokens for do+n't
                results.append({
                    "original_input": text,
                    "user_id": user_id,
                    "preference_type": "dislikes",
                ...
                activity = doc[start+4].text.lower()  # Index is +4 because of the split tokens for do+n't
                results.append({
                    "original_input": text,
                    "user_id": user_id,
                    "preference_type": "dislikes",
        ...
        # Define sentiment words, to be updated as needed
        ...
        # Define activity verbs for categorization, to be updated as needed
        activity_verbs = {
